  ...
  const services = [
    {
      id: 1,
      title: "オンライン授業",
      icon: getAssetPath('2025/02/1.png'),
    ...
    },
    {
      id: 2,
      title: "オフラインイベント",
      icon: getAssetPath('2025/02/2.png'),
      shortDesc: "秋田県内で定期開催",
    ...
    },
    {
      id: 3,
      title: "教育相談",
      icon: getAssetPath('2025/02/3.png'),
      shortDesc: "保護者向けサポート",
    ...
    },
    {
      id: 4,
      title: "案件割振",
      icon: getAssetPath('2025/02/4.png'),
      shortDesc: "実践的な仕事体験",
    ...
    },
    {
      id: 5,
      title: "独立サポート",
      icon: getAssetPath('2025/02/5.png'),
      shortDesc: "起業・独立を支援",
    ...
    },
    {
      id: 6,
      title: "AI先生",
      icon: getAssetPath('2025/02/6.png'),
      shortDesc: "24時間質問可能",
